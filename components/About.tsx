    ...
    >
        ...
        <div className="flex flex-col lgl:flex-row gap-16">
            <div className="w-full lgl:w-2/3 text-base text-textDark font-medium flex flex-col gap-4">
                <p>
                I am a creative and passionate fullstack developer with a fantastic sense for design and user experience. With a solid foundation in both frontend and backend technologies, I am quite enthusiastic about bridging the gap between design and functionality. My journey into software development started with a fascination for the art of creating visually stunning and functional websites. I am proficient in a versatile tech stack, including JavaScript, React, Node.js, Next.js HTML5 and CSS3</p>
